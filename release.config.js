module.exports = {
  ...
  "plugins": [
    ...
    ["@semantic-release/exec", {
      ...
      "successCmd": "appledoc --project-name Amplitude --project-company \"Amplitude Inc\" --company-id com.amplitude --no-create-docset --output ./doc/ . && rsync -av doc/html/*  Amplitude-iOS-gh-pages/ && cd Amplitude-iOS-gh-pages && git commit -m '${nextRelease.version}' && git push"
    }],
  ],
}
